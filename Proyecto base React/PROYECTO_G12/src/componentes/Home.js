...
const Home = () => {
    ...
    return (
        <main className='flex-1'>
            <div className='w-full bg-white border-double border-8 border-black rounded-lg text-center'>
                <h1 className='inline p-8 bg-gradient-to-r from-black via-red-700 to-black bg-clip-text font-display text-5xl tracking-tight text-transparent font-bold font-sans'>
                    Funko Ventas
                </h1>
                <Link className="block text-center my-5 text-black" to={"/login"}>
                    Iniciar Sesión
                </Link>
            ...
            <div className="flex-1 bg-white">
                <div className="py-16 sm:py-24 xl:mx-auto xl:max-w-7xl xl:px-8">
                    <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
                        <h2 className="text-2xl font-bold tracking-tight text-gray-900">Ver por categorias</h2>
            ...
            <div className="bg-gray-300">
                <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                    <h2 className="text-xl font-bold text-gray-900">Ver productos</h2>
